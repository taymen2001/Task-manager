<template>
  <v-row justify="center" align="center">
    <!-- Start, end date and time selector-->
    <v-menu
      ...
      offset-x
    >
      <!-- Card for the selector -->
      <v-card color="white">
        <v-row>
          <!-- First collumn, the start date selector -->
          <v-col cols="1"></v-col>
          <v-col cols="4">
            <v-menu
              ref="startdateref"
          ...
          <v-col cols="2"></v-col>
          <!-- The second collumn, the start time selector -->
          <v-col cols="4">
            <v-menu
              ref="menu3"
              v-model="menu3"
          ...
          <v-col cols="1"></v-col>
          <!-- The third collumn, the end date selector-->
          <v-col cols="4">
            <v-menu
          ...
          <v-col cols="2"></v-col>
          <!-- The fourth collumn, the end time selector-->
          <v-col cols="4">
            <v-menu
              ref="picktime2"
              v-model="menu4"
    ...
    <!-- The color picker for the calendar card color-->
    <v-menu
